...
const Products = () => {
  return (
    <div> {/* Main container */}
      ...
      {/* Products Grid Section - Redesigned Layout */}
      <div className="container mx-auto px-4 py-16"> {/* Increased vertical padding */}
        ...
        {/* Grid Layout - Adjusted gaps and columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10"> 
          {productsData.map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-lg border border-gray-200 shadow-md hover:shadow-xl overflow-hidden flex flex-col transition-shadow duration-300" /* Added border, adjusted shadow */
            >
              <img
                src={product.image}
                alt={product.name}
              ...
              <div className="p-5 flex flex-col flex-grow"> 
                ...
                <div className="flex justify-between items-center mt-auto pt-4 border-t border-gray-100"> 
                  ...
                  <button className="bg-blue-600 text-white px-5 py-2 rounded-md text-sm font-medium hover:bg-blue-700 transition duration-300"> {/* Adjusted padding, color, added font-medium */}
                    Add to Quote
                  </button>
                </div>
              </div>
